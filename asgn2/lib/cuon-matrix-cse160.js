 ...
 */
 ...
 class Vector3 {
    constructor(opt_src) {
        ...
        for(var i = 0; i < 3; i++){
          if (isNaN(v[i])){
              v[i]= 0; //initialize to 0 if no field
          }
        }
        this.elements = v;
    }
    ...
    static cross(other1, other2) {
        ...
        let v3y = other1.elements[0] * other2.elements[2] - other1.elements[2] * other2.elements[0];
    ...
    normalize() {
        ...
        this.elements[0] = x/(magnitude);
        this.elements[1] = y/(magnitude);
        this.elements[2] = z/(magnitude);
        // Don't delete the return statement.
        return this;
    };
}
